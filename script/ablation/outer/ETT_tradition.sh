...
# attack_algos=('GGAA' 'GGAA_NIFGSM' 'GGAA_VMIFGSM' 'GGAA_VNIFGSM' 'GGAA_IEFGSM' 'GGAA_AIFGTM' 'GGAA_AdaMSI_FGM')
attack_algos=('GGAA' 'GGAA_FGSM' 'GGAA_BIM' 'GGAA_PGD')
        ...
        for model_name2 in "${models[@]}"; do
                for attack_algo in "${attack_algos[@]}"; do
                    ...
                    python -u run.py \
                        ...
                        --itr $itr \
                        --save_sample_delta 1 \
                        --record_name 'ablation_outer_tradition'
                        done
                    done
                done
            done
