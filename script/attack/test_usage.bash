...
# kinds=('mask' 'optimize' 'global' 'dim_global' 'tim_global' 'dropout_global' 'aug' 'aug_opti')
...
# attack_algos=('GGAA' 'GGAA_NIFGSM' 'GGAA_VMIFGSM' 'GGAA_FGSM' 'GGAA_BIM' 'GGAA_PGD' 'GGAA_VNIFGSM' 'GGAA_IEFGSM' 'GGAA_AIFGTM' 'GGAA_AdaMSI_FGM' 'NIFGSM' 'VMIFGSM' 'VNIFGSM' 'IEFGSM' 'AIFGTM' 'AdaMSI_FGM')
# attack_algos=('GGAA_VNIFGSM')
