...
class GGAA_BIM(GlobalGradientAccumulationAttack):
    """
    GGAA with BIM (Global)
    """
    def __init__(self, attack, model, epsilon, norm, device=None, args=None, metrics='mae', epoch=10, decay=0, time_window=None, drop_ratio=0.5, alpha_times=1):
